...
{
    public static Item SmallTank = new Item();
    public static Item Shelf = new Item();
    public static Item AlgaeWafer = new Item();
    public static Item FoodPellet = new Item();
    public static Item MedSmallHead = new Medicine();
    public static Item MedBubble = new Medicine();
    public static Item MedVibrance = new Medicine();
    public static Item UpHeat0 = new Item();
    public static Item UpHeat1 = new Item();
    public static Item UpFilt0 = new Item();
    public static Item UpFilt1 = new Item();
    public static Item DecorGM = new Item();
    public static Item DecorDL = new Item();
    public static Item DecorRG = new Item();
    public static Item DecorWR = new Item();
    public static Item DecorLP = new Item();
}
